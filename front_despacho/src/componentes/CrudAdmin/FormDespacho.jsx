...
import { VENTAS_API_BASE, DESPACHOS_API_BASE } from "../../config";
...
export const FormDespacho = ({ venta, onClose }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      await axios.put(
        `${VENTAS_API_BASE}/api/v1/ventas/${venta.idVenta}`,
        jsonDataSales,
        {
          headers:{
      ...
      await axios.post(`${DESPACHOS_API_BASE}/api/v1/despachos`, jsonData, {
        headers:{
          'Content-Type': 'application/json',
          'Accept': 'application/json'
    }
